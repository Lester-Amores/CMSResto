...
export default function EditUnit({ onSuccess, unitId }: EditUnitProps) {
    ...
    const onSubmit: SubmitHandler<Unit> = (data) => {
        ...
        router.post(route('units.update', unitId), formData, {
            preserveScroll: true,
            onSuccess: (page) => {
    ...
    return (
        <div className="px-8 py-6 dark:text-white">
            <h2 className="text-2xl font-semibold mb-10">Edit Unit</h2>
            {isLoading ? (
                <p>Loading...</p>
            ) : (
